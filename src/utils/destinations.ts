...
export function lookupKnownCoordinates(placeName: string): Coordinates {
...
// short names, and dining establishments) so fuzzy activity names still resolve to the right pin.
// ---------------------------------------------------------------------------
export const SPOT_COORDINATES_DB: Record<string, Record<string, Coordinates>> = {
  azpeitia: {
    "Santuario de Loyola & Baroque Basilica": { lat: 43.1746, lng: -2.2842 },
    "Santuario de Loyola": { lat: 43.1746, lng: -2.2842 },
    "Loiola Sanctuary": { lat: 43.1746, lng: -2.2842 },
    "Loiola Santutegia": { lat: 43.1746, lng: -2.2842 },
    "Basílica de Loyola": { lat: 43.1746, lng: -2.2842 },
    "Loiola": { lat: 43.1746, lng: -2.2842 },
    "Loyola": { lat: 43.1746, lng: -2.2842 },
    "Basque Railway Museum (Burnibidearen Euskal Museoa)": { lat: 43.1848, lng: -2.2611 },
    "Basque Railway Museum": { lat: 43.1848, lng: -2.2611 },
    "Euskal Trenbidearen Museoa": { lat: 43.1848, lng: -2.2611 },
    "Burnibidearen Euskal Museoa": { lat: 43.1848, lng: -2.2611 },
    "Izarraitz Mountain Ridge & Erlo Summit": { lat: 43.2066, lng: -2.2805 },
    "Erlo Summit": { lat: 43.2066, lng: -2.2805 },
    "Erlo": { lat: 43.2066, lng: -2.2805 },
    "Izarraitz": { lat: 43.2066, lng: -2.2805 },
    "Urola River Greenway & Historic Plaza Nagusia": { lat: 43.1839, lng: -2.2659 },
    "Plaza Nagusia": { lat: 43.1839, lng: -2.2659 },
    "Enparantza Nagusia": { lat: 43.1839, lng: -2.2659 },
    "Sanagustin Kulturgunea": { lat: 43.1839, lng: -2.2659 },
    "San Agustin": { lat: 43.1839, lng: -2.2659 },
    "Soreasu Parish Church & Historic Tower Houses": { lat: 43.1864, lng: -2.2642 },
    "Soreasu Antzokia": { lat: 43.1864, lng: -2.2642 },
    "Soreasu": { lat: 43.1864, lng: -2.2642 },
    "Restaurante Kiruri": { lat: 43.1761, lng: -2.2818 },
    "Kiruri": { lat: 43.1761, lng: -2.2818 },
    "Restaurante Larrañaga": { lat: 43.1718, lng: -2.2623 },
    "Larrañaga": { lat: 43.1718, lng: -2.2623 },
  },
  azkoitia: {
    "Intsausti Palace & Noble Quarter": { lat: 43.1788, lng: -2.3082 },
    "Palacio Intsausti": { lat: 43.1788, lng: -2.3082 },
    "Jorge Oteiza Pelota Courts": { lat: 43.1768, lng: -2.3115 },
    "Frontones Oteiza": { lat: 43.1768, lng: -2.3115 },
    "Casco Histórico & Plaza de la Verdura": { lat: 43.1782, lng: -2.3117 },
    "Plaza de la Verdura": { lat: 43.1782, lng: -2.3117 },
    "Balda Tower & Historic Alleyways": { lat: 43.1788, lng: -2.3130 },
    "Torre Balda": { lat: 43.1788, lng: -2.3130 },
    "Joseba Jatetxea": { lat: 43.1776, lng: -2.3108 },
  },
  zarautz: {
    "Zarautz Long Beach & Surf Promenade": { lat: 43.2872, lng: -2.1705 },
    "Zarautz Beach": { lat: 43.2872, lng: -2.1705 },
    "Playa de Zarautz": { lat: 43.2872, lng: -2.1705 },
    "Santa Bárbara Viewpoint & Txakoli Vineyards": { lat: 43.2885, lng: -2.1810 },
    "Santa Bárbara": { lat: 43.2885, lng: -2.1810 },
    "Luzea Tower & Gothic Historic Quarter": { lat: 43.2855, lng: -2.1712 },
    "Torre Luzea": { lat: 43.2855, lng: -2.1712 },
    "Iñurritza Dune Nature Reserve": { lat: 43.2860, lng: -2.1580 },
    "Iñurritza Dunes": { lat: 43.2860, lng: -2.1580 },
    "Restaurante Karlos Arguiñano": { lat: 43.2878, lng: -2.1648 },
    "Telesforo Jatetxea": { lat: 43.2852, lng: -2.1730 },
  },
  tolosa: {
    "El Tinglado Saturday Farmers' Market": { lat: 43.1375, lng: -2.0740 },
    "Tinglado": { lat: 43.1375, lng: -2.0740 },
    "Zerkausia": { lat: 43.1375, lng: -2.0740 },
    "TOPIC International Puppet Art Center": { lat: 43.1368, lng: -2.0715 },
    "TOPIC": { lat: 43.1368, lng: -2.0715 },
    "Traditional Asador Steakhouses (Casa Julián)": { lat: 43.1362, lng: -2.0728 },
    "Casa Julián": { lat: 43.1362, lng: -2.0728 },
    "Asador Casa Julian": { lat: 43.1362, lng: -2.0728 },
    "Oria River Promenade & Zerkausia Market": { lat: 43.1355, lng: -2.0735 },
    "Frontón Beotibar": { lat: 43.1370, lng: -2.0720 },
  },
  zumaia: {
    "Itzurun Beach Flysch Cliffs (UNESCO Geopark)": { lat: 43.3015, lng: -2.2615 },
    "Itzurun Beach": { lat: 43.3015, lng: -2.2615 },
    "Flysch Cliffs": { lat: 43.3015, lng: -2.2615 },
    "Hermitage of San Telmo & Cliff Overlook": { lat: 43.3021, lng: -2.2612 },
    "San Telmo": { lat: 43.3021, lng: -2.2612 },
    "Ermita de San Telmo": { lat: 43.3021, lng: -2.2612 },
    "Zumaia Marina & Urola Estuary Promenade": { lat: 43.2985, lng: -2.2560 },
    "Algorri Interpretive Center": { lat: 43.2995, lng: -2.2595 },
  },
  getaria: {
    "Cristóbal Balenciaga Haute Couture Museum": { lat: 43.3033, lng: -2.2045 },
    "Balenciaga Museum": { lat: 43.3033, lng: -2.2045 },
    "Museo Balenciaga": { lat: 43.3033, lng: -2.2045 },
    "El Ratón de Getaria (Mount San Anton)": { lat: 43.3056, lng: -2.2025 },
    "Ratón de Getaria": { lat: 43.3056, lng: -2.2025 },
    "Mount San Anton": { lat: 43.3056, lng: -2.2025 },
    "Fishing Harbor Charcoal-Grilled Turbot Restaurants": { lat: 43.3038, lng: -2.2038 },
    "Restaurante Elkano": { lat: 43.3018, lng: -2.2052 },
    "Kaia Kaipe": { lat: 43.3038, lng: -2.2038 },
    "Hillside Txakoli Vineyards": { lat: 43.3015, lng: -2.2105 },
    "Txakoli Txomin Etxaniz": { lat: 43.2988, lng: -2.2132 },
  },
  hondarribia: {
    "La Marina Neighborhood (Colorful Fishermen's Balconies)": { lat: 43.3635, lng: -1.7925 },
    "La Marina": { lat: 43.3635, lng: -1.7925 },
    "Calle San Pedro": { lat: 43.3635, lng: -1.7925 },
    "Parador de Carlos V Castle": { lat: 43.3645, lng: -1.7915 },
    "Parador de Hondarribia": { lat: 43.3645, lng: -1.7915 },
    "Kale Nagusia Historic Stone Ramparts": { lat: 43.3630, lng: -1.7910 },
    "Bidasoa Estuary Promenade & Pintxo Bars": { lat: 43.3640, lng: -1.7940 },
    "Gran Sol Pintxos": { lat: 43.3635, lng: -1.7925 },
  },
  pasaisia: {
    "Albaola Sea Factory of the Basques": { lat: 43.3275, lng: -1.9288 },
    "Albaola": { lat: 43.3275, lng: -1.9288 },
    "Victor Hugo Historic House Museum": { lat: 43.3268, lng: -1.9192 },
    "Victor Hugo": { lat: 43.3268, lng: -1.9192 },
    "Pasai Donibane Waterfront Cobblestone Street": { lat: 43.3268, lng: -1.9192 },
    "Pasai Donibane": { lat: 43.3268, lng: -1.9192 },
    "Green Fjord Channel & Boat Shuttle": { lat: 43.3260, lng: -1.9215 },
    "Ziaboga Jatetxea": { lat: 43.3265, lng: -1.9198 },
  },
  ordizia: {
    "Wednesday Agricultural & Idiazabal Cheese Market (Since 1268)": { lat: 43.0540, lng: -2.1790 },
    "Ordizia Market": { lat: 43.0540, lng: -2.1790 },
    "D'Elikatuz Food & Gastronomy Center": { lat: 43.0535, lng: -2.1780 },
    "Goierri Valley Highland Trailhead": { lat: 43.0580, lng: -2.1830 },
  },
  "donostia-san-sebastian": {
    "Playa de La Concha & Promenade": { lat: 43.3172, lng: -1.9868 },
    "La Concha": { lat: 43.3172, lng: -1.9868 },
    "Playa de La Concha": { lat: 43.3172, lng: -1.9868 },
    ...
    "Funicular de Igueldo": { lat: 43.3168, lng: -2.0042 },
    ...
    "Bar Nestor": { lat: 43.3238, lng: -1.9837 },
    "La Cuchara de San Telmo": { lat: 43.3242, lng: -1.9830 },
    "Ganbara": { lat: 43.3235, lng: -1.9848 },
    "Bar Txepetxa": { lat: 43.3232, lng: -1.9845 },
    "Zurriola Beach & Kursaal Auditorium in Gros": { lat: 43.3243, lng: -1.9787 },
    "Zurriola Beach": { lat: 43.3255, lng: -1.9740 },
    "Kursaal": { lat: 43.3243, lng: -1.9787 },
  ...
  kyoto: {
    ...
    "Ginkaku-ji": { lat: 35.0272, lng: 135.7982 },
    "Pontocho Alley & Gion Teahouses": { lat: 35.0062, lng: 135.7712 },
    "Pontocho": { lat: 35.0062, lng: 135.7712 },
    "Gion": { lat: 35.0037, lng: 135.7770 },
  ...
  barcelona: {
    ...
    "Barri Gòtic": { lat: 41.3833, lng: 2.1777 },
    ...
    "Bunkers del Carmel Panoramic Sunset": { lat: 41.4190, lng: 2.1620 },
    "Bunkers del Carmel": { lat: 41.4190, lng: 2.1620 },
  },
  rome: {
    ...
    "Trastevere": { lat: 41.8880, lng: 12.4690 },
  ...
  lisbon: {
    ...
    "Alfama": { lat: 38.7131, lng: -9.1290 },
    "Belém Tower & Pastéis de Belém": { lat: 38.6916, lng: -9.2160 },
    "Belém Tower": { lat: 38.6916, lng: -9.2160 },
  ...
  porto: {
    ...
    "Ribeira": { lat: 41.1405, lng: -8.6110 },
    "Livraria Lello Historic Neo-Gothic Bookstore": { lat: 41.1460, lng: -8.6150 },
    "Livraria Lello": { lat: 41.1460, lng: -8.6150 },
